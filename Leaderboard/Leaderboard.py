...
#    Updated: 2024/08/21 16:50:14 by ele-lean         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
try:
	...
	print("\033[0;92mRun 'python3 /sgoinfre/goinfre/Perso/ele-lean/Leaderboard/scrap.py' to update data.\033[0;0m")
	print("""\033[0;93m
                                   ___---___
                             ___---___---___---___
                       ___---___---    *    ---___---___
...
===============================================================================
 ...
 \__/=====\__/                     __________                    \__/=====\__/
    |||||||                        |\033[0;33m\033]8;;https://profile.intra.42.fr/users/""" + result[0][0] + """\033\\""" + (result[0][0] + " " * (8 - len(result[0][0]))) + """\033]8;;\033\\\033[0;93m|                       |||||||
    ...
    |||||||        \033[0;90m\ """ + (' ' * (3 - (len(str(result[1][1]))//2))) + str(result[1][1]) + (' ' * (3 - (len(str(result[1][1]))//2))) + """ /       \033[0;93m|      |\033[0;93m       \033[0;94m|\033]8;;https://profile.intra.42.fr/users/""" + result[2][0] + """\033\\""" + (result[2][0] + " " * (8 - len(result[2][0]))) + """\033]8;;\033\\|\033[0;93m       |||||||
    |||||||         \033[0;90m|      |\033[0;93m        |      |\033[0;93m       \033[0;94m|   🥉   |\033[0;93m       |||||||
    |||||||         \033[0;90m|      |\033[0;93m        |      |\033[0;93m       \033[0;94m\\ """ + (' ' * (3 - (len(str(result[2][1]))//2))) + str(result[2][1]) + (' ' * (3 - (len(str(result[2][1]))//2))) + """ /\033[0;93m       |||||||
